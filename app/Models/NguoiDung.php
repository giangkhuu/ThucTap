...
class NguoiDung extends Authenticatable
{
    ...
    {
        return $this->hasMany(GioHang::class, 'nguoidung_id', 'id');
    }
    ...
    public function LienHe(): HasMany
    {
        return $this->hasMany(LienHe::class, 'nguoidung_id', 'id');
    }

    public function BinhLuanThuoc(): HasMany
    {
        return $this->hasMany(BinhLuanThuoc::class, 'nguoidung_id', 'id');
    }
...
class CustomResetPasswordNotification extends ResetPassword
{
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->action('Khôi phục mật khẩu', url(env('app.url') . route('password.reset', $this->token, false)))
