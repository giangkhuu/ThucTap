...
<div class="container pb-5 mb-2 mb-md-4">
    <div class="row">
                ...
                <div class="d-lg-block collapse" id="account-menu">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="border-bottom mb-0">
                            <a class="nav-link-style d-flex align-items-center px-4 py-3" href="{{ route('user.donhang') }}"><i class="ci-bag opacity-60 me-2"></i>Đơn hàng<span class="fs-sm text-muted ms-auto">{{ $nguoidung->DonHang->count() }}</span>
                            </a>
                        </li>
                        @else
                        <li class="border-bottom mb-0">
        ...
        <section class="col-lg-8">
            ...
            @endif
            <form action="{{ route('user.hosocanhan') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                @csrf
                <div class="bg-secondary rounded-3 p-4 mb-4">
                    <div class="d-flex align-items-center">
                        @if(empty($nguoidung->hinhanh))
                        <img class="rounded" src="{{ asset('img/avatar.jpg') }}" width="90" />
                        @else
                        <img class="rounded" src="{{ env('APP_URL') . '/storage/app/' . $nguoidung->hinhanh }}" width="90" />
                        @endif
                        <div class="ps-3">
                            <label class="btn btn-light btn-shadow btn-sm mb-2">
                                <i class="ci-loading me-2"></i>Đổi ảnh đại diện
                                <input type="file" class="form-control visually-hidden" id="hinhanh" name="hinhanh" />
                            </label>
                ...
                <div class="row gx-4 gy-3">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control @error('sdt') is-invalid @enderror" id="sdt" name="sdt" value="{{ $nguoidung->sdt }}" required />
                        @error('sdt')
                        <div class="invalid-feedback"><strong>{{ $message }}</strong></div>
                        @enderror
                    </div>
